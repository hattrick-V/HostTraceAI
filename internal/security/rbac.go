...
var PermissionCatalog = map[string]string{
	...
	"files:read":           "View trace archives",
	"files:write":          "Upload, edit, and rename trace archives",
	"files:delete":         "Delete trace archives",
	"attackchain:read":     "View trace paths",
	"attackchain:write":    "Regenerate trace paths",
