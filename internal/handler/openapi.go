...
func (h *OpenAPIHandler) GetOpenAPISpec(c *gin.Context) {
	...
	spec := map[string]interface{}{
		...
		"info": map[string]interface{}{
			"title":       "HostTraceAI API",
			"description": "HostTraceAI 主机溯源平台 API 文档",
			"version":     "1.0.0",
			...
			"schemas": map[string]interface{}{
				"CreateConversationRequest": map[string]interface{}{
					...
					"properties": map[string]interface{}{
						...
						"projectId": map[string]interface{}{
							"type":        "string",
							"description": "绑定的调查分组 ID（可选，用于跨对话共享事实黑板）",
						},
					},
				},
				"SetConversationProjectRequest": map[string]interface{}{
					...
					"properties": map[string]interface{}{
						"projectId": map[string]interface{}{
							"type":        "string",
							"description": "调查分组 ID；空字符串表示解除绑定",
						},
					},
				...
				"AssetImportItem": map[string]interface{}{
					...
					"properties": map[string]interface{}{
						"project_id":         map[string]interface{}{"type": "string", "description": "所属调查分组 ID；调用者必须有权访问"},
		...
		"paths": map[string]interface{}{
				...
				"get": map[string]interface{}{
					...
					"parameters": []map[string]interface{}{
						...
						},
						{
							...
							"in":          "query",
							"required":    false,
							"description": "按调查分组筛选；传 __none__ 表示仅未绑定调查分组的对话",
							"schema": map[string]interface{}{
								"type": "string",
							},
						},
			...
			"/api/conversations/{id}/project": map[string]interface{}{
				"put": map[string]interface{}{
					"tags":        []string{"对话管理"},
					"summary":     "设置对话所属调查分组",
					"description": "绑定或解除对话与调查分组的关联，用于跨对话共享事实黑板",
					...
					"responses": map[string]interface{}{
						...
						"400": map[string]interface{}{"description": "调查分组不存在或参数错误"},
			...
			"/api/eino-agent": map[string]interface{}{
				"post": map[string]interface{}{
					...
					"description": "向 AI 发送消息并获取回复（非流式）。由 **CloudWeGo Eino** `adk.NewChatModelAgent` + `adk.NewRunner.Run` 执行单代理 MCP 工具链。**不依赖** `multi_agent.enabled`；`multi_agent.eino_skills` / `eino_middleware` 等与多代理主代理一致时可生效。支持角色与附件。",
			...
			"/api/multi-agent": map[string]interface{}{
				"post": map[string]interface{}{
					...
					"description": "与 `POST /api/eino-agent` 请求体相同，但由 **CloudWeGo Eino** 多代理执行。编排由请求体 `orchestration`（`deep` | `plan_execute` | `supervisor`）指定，缺省为 `deep`。**前提**：`multi_agent.enabled: true`；未启用时返回 404 JSON。",
			...
			"/api/multi-agent/stream": map[string]interface{}{
				"post": map[string]interface{}{
					...
					"description": "与 `POST /api/eino-agent/stream` 类似；由 Eino 多代理执行。`orchestration` 指定 deep / plan_execute / supervisor，缺省 deep。`response_start` / `response_delta` 仅为候选/过程输出；只有 `type: response` 且 `data.finalized=true` 才表示成功最终回复。缺 completed 执行证据时可能先发送 `finalization_auto_continue`，表示服务端基于已有 trace 无注入续跑。**前提**：`multi_agent.enabled: true`；未启用时 SSE 内首条为 `type: error` 后接 `done`。",
			...
			"/api/batch-tasks/{queueId}/tasks": map[string]interface{}{
				"post": map[string]interface{}{
					"tags":        []string{"批量任务"},
					"summary":     "添加任务到队列",
					"description": "向批量任务队列添加新任务。任务会添加到队列末尾，按照队列顺序依次执行。每个任务会创建一个独立的对话，支持完整的状态跟踪。\n**任务格式**：\n任务内容是一个字符串，描述要执行的溯源调查任务。例如：\n- \"溯源 203.0.113.10 的入侵入口与影响范围\"\n- \"调查 192.168.1.1 的异常外联行为\"\n- \"排查 https://example.com 的篡改与 Webshell 痕迹\"\n**使用示例**：\n```json\n{\n  \"task\": \"溯源 203.0.113.10 的入侵入口与影响范围\"\n}\n```",
							...
							"application/json": map[string]interface{}{
								"schema": map[string]interface{}{
									...
									"properties": map[string]interface{}{
										"task": map[string]interface{}{
											"type":        "string",
											"description": "任务内容，描述要执行的溯源调查任务（必需）",
											"example":     "溯源 203.0.113.10 的入侵入口与影响范围",
										},
									},
								},
								"examples": map[string]interface{}{
									...
									"portScan": map[string]interface{}{
										"summary":     "异常外联调查",
										"description": "调查内部主机的异常外联行为",
										"value": map[string]interface{}{
											"task": "调查 192.168.1.1 的异常外联行为",
										},
									},
								},
							},
			...
			"/api/assets/import": map[string]interface{}{
				"post": map[string]interface{}{
					...
					"responses": map[string]interface{}{
						...
						"401": map[string]interface{}{"description": "未授权"},
						"403": map[string]interface{}{"description": "缺少 asset:write 权限或无权访问指定调查分组"},
			...
			// 旧测绘、通用终端与 WebShell 管理 API 已从开源主机溯源版 OpenAPI 文档移除。

			// ==================== 溯源归档包 ====================
			"/api/trace-archives": map[string]interface{}{
				"get": map[string]interface{}{
					"tags":        []string{"溯源归档包"},
					"summary":     "列出归档包",
					"description": "获取溯源归档包列表，包含人工上传归档、工具输出和会话产物，可按会话、调查分组、来源、文件名搜索和分页过滤。",
					"operationId": "listTraceArchives",
					"parameters": []map[string]interface{}{
						{"name": "conversation", "in": "query", "required": false, "description": "按对话ID过滤", "schema": map[string]interface{}{"type": "string"}},
						{"name": "project", "in": "query", "required": false, "description": "按调查分组ID过滤", "schema": map[string]interface{}{"type": "string"}},
				...
				"post": map[string]interface{}{
					"tags":        []string{"溯源归档包"},
					"summary":     "上传归档包",
					"description": "上传 ZIP 归档包到溯源归档目录（multipart/form-data）。",
					"operationId": "uploadTraceArchive",
					"requestBody": map[string]interface{}{
						"required": true,
						"content": map[string]interface{}{
							"multipart/form-data": map[string]interface{}{
								"schema": map[string]interface{}{
									...
									"properties": map[string]interface{}{
										"file":           map[string]interface{}{"type": "string", "format": "binary", "description": "上传的 ZIP 归档包"},
				...
				"delete": map[string]interface{}{
					"tags":        []string{"溯源归档包"},
					"summary":     "删除归档包",
					"description": "删除指定的溯源归档包。",
					"operationId": "deleteTraceArchive",
					"requestBody": map[string]interface{}{
						"required": true,
						"content": map[string]interface{}{
							"application/json": map[string]interface{}{
			...
			"/api/trace-archives/export": map[string]interface{}{
				"get": map[string]interface{}{
					"tags":        []string{"溯源归档包"},
					"summary":     "导出归档包",
					"description": "按当前过滤条件导出溯源归档 ZIP，包含 manifest.json。",
					"operationId": "exportTraceArchives",
					"parameters": []map[string]interface{}{
						{"name": "conversation", "in": "query", "required": false, "description": "按对话ID过滤", "schema": map[string]interface{}{"type": "string"}},
						{"name": "project", "in": "query", "required": false, "description": "按调查分组ID过滤", "schema": map[string]interface{}{"type": "string"}},
						{"name": "source", "in": "query", "required": false, "description": "按来源过滤：upload/reduction/workspace/conversation_artifact/all", "schema": map[string]interface{}{"type": "string", "enum": []string{"all", "upload", "reduction", "workspace", "conversation_artifact"}}},
			...
			"/api/trace-archives/download": map[string]interface{}{
				"get": map[string]interface{}{
					"tags":        []string{"溯源归档包"},
					"summary":     "下载归档包",
					"description": "下载指定的溯源归档包。",
					"operationId": "downloadTraceArchive",
					"parameters": []map[string]interface{}{
			...
			"/api/trace-archives/path": map[string]interface{}{
				"get": map[string]interface{}{
					"tags":        []string{"溯源归档包"},
					"summary":     "解析归档路径",
					"description": "将归档页面中的相对路径或内部虚拟路径解析为服务器绝对路径，用于审计、复核或报告引用。",
					"operationId": "resolveTraceArchivePath",
					"parameters": []map[string]interface{}{
			...
			"/api/trace-archives/content": map[string]interface{}{
				"get": map[string]interface{}{
					"tags":        []string{"溯源归档包"},
					"summary":     "获取归档文本内容",
					"description": "读取并返回文本文件的内容。",
					"operationId": "getTraceArchiveContent",
					"parameters": []map[string]interface{}{
						{"name": "path", "in": "query", "required": true, "description": "文件相对路径", "schema": map[string]interface{}{"type": "string"}},
					},
					"responses": map[string]interface{}{
				...
				"put": map[string]interface{}{
					...
					"operationId": "putTraceArchiveContent",
					"requestBody": map[string]interface{}{
						"required": true,
						"content": map[string]interface{}{
							"application/json": map[string]interface{}{
			...
			"/api/trace-archives/mkdir": map[string]interface{}{
				"post": map[string]interface{}{
					"tags":        []string{"溯源归档包"},
					"summary":     "创建归档目录",
					"description": "在溯源归档目录下创建子目录。",
					"operationId": "mkdirTraceArchive",
					"requestBody": map[string]interface{}{
						"required": true,
						"content": map[string]interface{}{
							"application/json": map[string]interface{}{
			...
			"/api/trace-archives/rename": map[string]interface{}{
				"put": map[string]interface{}{
					"tags":        []string{"溯源归档包"},
					"summary":     "重命名归档包",
					"description": "重命名溯源归档包或目录。",
					"operationId": "renameTraceArchive",
					"requestBody": map[string]interface{}{
						"required": true,
						"content": map[string]interface{}{
							"application/json": map[string]interface{}{
