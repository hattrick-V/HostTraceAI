...
func init() {
	schema.RegisterName[*WorkflowLocalState]("_hosttrace_workflow_local_state")
	schema.RegisterName[NodeOutputEnvelope]("_hosttrace_workflow_node_output_envelope")
	schema.RegisterName[StartOutput]("_hosttrace_workflow_start_output")
	schema.RegisterName[ConditionOutput]("_hosttrace_workflow_condition_output")
	schema.RegisterName[ToolOutput]("_hosttrace_workflow_tool_output")
	schema.RegisterName[AgentOutput]("_hosttrace_workflow_agent_output")
	schema.RegisterName[HITLOutput]("_hosttrace_workflow_hitl_output")
	schema.RegisterName[OutputNodeOutput]("_hosttrace_workflow_output_node_output")
}
