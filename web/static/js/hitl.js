...
const HITL_LOGS_PAGE_SIZE_KEY = 'hosttrace_hitl_logs_page_size';
const HITL_PENDING_PAGE_SIZE_KEY = 'hosttrace_hitl_pending_page_size';
const HITL_TIMEOUT_DEFAULT_MIGRATION_PREFIX = 'hosttrace-hitl-timeout-default-v1:';
...
function readHitlLocalStorageConv(conversationId) {
    ...
    try {
        const key = 'hosttrace-chat-hitl:' + String(conversationId).trim();
