## HostTraceAI Browser Extension

**Version 0.3.10** — Full docs: **README.zh-CN.md**

Chromium DevTools extension: capture Network traffic and send it to HostTraceAI for AI-assisted analysis.

### Quick install

1. `chrome://extensions/` → Developer mode → **Load unpacked**
2. Select `plugins/browser-extension/hosttrace-browser-extension/`
3. Open target page → **F12** → **HostTraceAI** tab → **Validate**
